/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 22cfd6618698c3be8574872c95277345)
// Runtime types generated with workerd@1.20260730.1 2026-07-30 nodejs_compat
interface __BaseEnv_Env {
	AAT_OBJECTS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	...
	AAT_RP_ID: string;
	AAT_RP_NAME: string;
	AAT_TRUSTED_ORIGINS: string;
	POSTER_RENDERER: DurableObjectNamespace<import("./worker/index").PosterRendererContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "PosterRendererContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AAT_DEFAULT_QUOTA_BYTES" | "AAT_MAX_SNAPSHOT_BYTES" | "AAT_MAX_SOURCE_BYTES" | "AAT_MAX_POSTER_BYTES" | "AAT_MAX_CONCURRENT_RENDERS" | "AAT_RENDER_STALE_SECONDS" | "AAT_RESERVATION_TTL_SECONDS" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "AAT_RP_ID" | "AAT_RP_NAME" | "AAT_TRUSTED_ORIGINS">> {}
}
